...
$(document).ready(function() {
    ...
    function open_lb(id){
        ...
        $('body').append('<div id="AI_lightbox"><span class="close"><i class="fas fa-times"></i></span><img src="" alt="" /><span class="prev"><i class="fas fa-angle-left"></i></span><span class="next"><i class="fas fa-angle-right"></i></span></div>');
